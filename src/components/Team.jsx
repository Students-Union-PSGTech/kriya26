...
const Team = () => {
    ...
    const coreMembers = [
        { name: "Arjun Reddy", role: "Lead Organizer" },
        { name: "Priya Sharma", role: "Tech Head" },
        { name: "Vikram Singh", role: "Design Lead" },
        { name: "Ananya Patel", role: "Event Coordinator" },
        { name: "Rohan Kumar", role: "Marketing Head" },
    ];
