            ...
            <div className="bg-black/80 backdrop-blur-md shadow-xl rounded-lg p-8 border border-white/10">
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-white/10 border border-white/20 text-[#dfdff2] py-3 px-4 rounded-full hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-[#edff66] font-general text-xs uppercase"
                    >
                    ...
                    <div className="relative flex items-center">
                        ...
                        <span className="flex-shrink mx-4 text-gray-400 font-general">OR</span>
                        <div className="flex-grow border-t border-white/20"></div>
                    </div>

                    <button
                        onClick={() => router.push('/auth?type=send-email')}
                        className="w-full bg-[#dfdff2] text-black py-3 px-4 rounded-full hover:bg-white transition-all font-general text-xs uppercase"
                    >
                        Register with Email
                    </button>
                </div>
